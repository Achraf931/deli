...
class detailScreen extends Component {
    ...
    render() {
        ...
        return (
            <Animated.ScrollView showsVerticalScrollIndicator={false} contentInsetAdjustmentBehavior="automatic" style={{ backgroundColor: 'white' }} onScroll={Animated.event([{ nativeEvent: { contentOffset: { y: this.scrollImage } } }], { useNativeDriver: true })}
            >
                            ...
                            return <View key={index}>
                                ...
                                >
                                    <View style={[styles.modalView]}>
                                        ...
                                        <View style={{ paddingHorizontal: 12, marginTop: 25, backgroundColor: "#FFFFFF" }}>
                                        ...
                                        <View style={{ paddingHorizontal: 12, marginTop: 25, flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center' }}>
                                            ...
                                            <Text style={{fontSize: 30, fontWeight: 'bold'}}>{this.state.itemChicken}</Text>
